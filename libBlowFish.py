...
class Blowfish:
    ...
    def __init__ (self, key):
        ...
        self.p_boxes = [
            ...
            0xA4093822, 0x299F31D0, 0x82EFA98, 0xEC4E6C89,
        ...
        self.s_boxes = [
            [
                ...
                0x250E2D, 0x2071B35E, 0x226800BB, 0x57B8E0AF,
                0x2464369B, 0xF009B91E, 0x5563911D, 0x59DFA6AA,
                0x78C14389, 0xD95A537F, 0x207D5BA2, 0x2E5B9C5,
                0x83260376, 0x6295CFA9, 0x11C81968, 0x4E734A41,
                0xB3472DCA, 0x7B14A94A, 0x1B510052, 0x9A532915,
                0xD60F573F, 0xBC9BC6E4, 0x2B60A476, 0x81E67400,
                0x8BA6FB5, 0x571BE91F, 0xF296EC6B, 0x2A0DD915,
            ...
            [
                ...
                0x4CDD2086, 0x8470EB26, 0x6382E9C6, 0x21ECC5E,
                0x9686B3F, 0x3EBAEFC9, 0x3C971814, 0x6B6A70A1,
                0x687F3584, 0x52A0E286, 0xB79C5305, 0xAA500737,
                0x3E07841C, 0x7FDEAE5C, 0x8E7D44EC, 0x5716F2B8,
                0xB03ADA37, 0xF0500C0D, 0xF01C1F04, 0x200B3FF,
                0xAE0CF51A, 0x3CB574B2, 0x25837A58, 0xDC0921BD,
                0xD19113F9, 0x7CA92FF6, 0x94324773, 0x22F54701,
                0x3AE5E581, 0x37C2DADC, 0xC8B57634, 0x9AF3DDA7,
                0xA9446146, 0xFD0030E, 0xECC8C73E, 0xA4751E41,
                ...
                0x43556F1, 0xD7A3C76B, 0x3C11183B, 0x5924A509,
                ...
                0xE3BC4595, 0xA67BC883, 0xB17F37D1, 0x18CFF28,
                0xC332DDEF, 0xBE6C5AA5, 0x65582185, 0x68AB9802,
                0xEECEA50F, 0xDB2F953B, 0x2AEF7DAD, 0x5B6E2F84,
                0x1521B628, 0x29076170, 0xECDD4775, 0x619F1510,
                0x13CCA830, 0xEB61BD96, 0x334FE1E, 0xAA0363CF,
                ...
                0xE358829, 0xC7E61FD6, 0x96DEDFA1, 0x7858BA99,
                ...
                0x95BBF00, 0xAD19489D, 0x1462B174, 0x23820E00,
                0x58428D2A, 0xC55F5EA, 0x1DADF43E, 0x233F7061,
                0x3372F092, 0x8D937E41, 0xD65FECF1, 0x6C223BDB,
                0x7CDE3759, 0xCBEE7460, 0x4085F2A7, 0xCE77326E,
                0xA6078084, 0x19F8509E, 0xE8EFD855, 0x61D99735,
                0xA969A7AA, 0xC50C06C2, 0x5A04ABFC, 0x800BCADC,
                0x9E447A2E, 0xC3453484, 0xFDD56705, 0xE1E9EC9,
            ...
            [
                ...
                0xFDF8E802, 0x4272F70, 0x80BB155C, 0x5282CE3,
                0x95C11548, 0xE4C66D22, 0x48C1133F, 0xC70F86DC,
                0x7F9C9EE, 0x41041F0F, 0x404779A4, 0x5D886E17,
                0x325F51EB, 0xD59BC0D1, 0xF2BCC18F, 0x41113564,
                0xE01CC87E, 0xBCC7D1F6, 0xCF0111C3, 0xA1E8AAC7,
                0x1A908749, 0xD44FBD9A, 0xD0DADECB, 0xD50ADA38,
                0x339C32A, 0xC6913667, 0x8DF9317C, 0xE0B12B4F,
                ...
                0xDF359F8D, 0x9B992F2E, 0xE60B6F47, 0xFE3F11D,
                ...
                0x1948C25C, 0x2FB8A8C, 0x1C36AE4, 0xD6EBE1F9,
        ...
        for i in range (0, len (self.p_boxes), 2):
            ...
            self.p_boxes[i] = l
            self.p_boxes[i + 1] = r
            #if key_len!=8:print "Pbox[%d,%d]:%x,%x" %(i,i+1,l,r)
        ...
        for i in range (len (self.s_boxes)):
            for j in range (0, len (self.s_boxes[i]), 2):
                ...
                #if key_len!=8:print "sbox[%d,%d]:%x,%x" %(i*0x100+j,i*0x100+j+1,l,r)
    ...
    def encrypt (self, data):
        ...
        xl = ord (data[0]) | (ord (data[1]) << 8) | (ord (data[2]) << 16) | (ord (data[3]) << 24)
        xr = ord (data[4]) | (ord (data[5]) << 8) | (ord (data[6]) << 16) | (ord (data[7]) << 24)

        cl, cr = self.cipher (xl, xr, self.ENCRYPT)
        chars = ''.join ([
            chr (cl & 0xFF), chr ((cl >> 8) & 0xFF), chr ((cl >> 16) & 0xFF), chr ((cl >> 24) & 0xFF),
            chr (cr & 0xFF), chr ((cr >> 8) & 0xFF), chr ((cr >> 16) & 0xFF), chr ((cr >> 24) & 0xFF)
        ])
        return chars
    ...
    def decrypt (self, data):
        ...
        # Use big endianess since that's what everyone else uses
        cl = ord (data[0]) | (ord (data[1]) << 8) | (ord (data[2]) << 16) | (ord (data[3]) << 24)
        cr = ord (data[4]) | (ord (data[5]) << 8) | (ord (data[6]) << 16) | (ord (data[7]) << 24)

        xl, xr = self.cipher (cl, cr, self.DECRYPT)
        chars = ''.join ([
            chr (xl & 0xFF), chr ((xl >> 8) & 0xFF), chr ((xl >> 16) & 0xFF), chr ((xl >> 24) & 0xFF),
            chr (xr & 0xFF), chr ((xr >> 8) & 0xFF), chr ((xr >> 16) & 0xFF), chr ((xr >> 24) & 0xFF)
        ])
        return chars
...
def decrypt_data(input_buffer , key):
    cipher=Blowfish(key)
    dec_buffer=StringIO()
    input_length=len(input_buffer)
    if not input_length%8 == 0:
        input_buffer+=('\x00'*(8-input_length%8))
    input_length=len(input_buffer)
    for i in range(0,input_length,8):
        enc_data=input_buffer[i : i + 8]
        decrypted = cipher.decrypt(enc_data)
        dec_buffer.write(decrypted)
    return dec_buffer.getvalue()
def encrypt_data(input_buffer , key):
    cipher = Blowfish(key)
    enc_buffer = StringIO()
    input_length = len(input_buffer)
    if not input_length % 8 == 0:
    ...
    input_length = len(input_buffer)
    for i in range(0,input_length,8):
        dec_data = input_buffer[i : i + 8]
        encrypted = cipher.encrypt(dec_data)
        enc_buffer.write(encrypted)
    return enc_buffer.getvalue()
'''end functions'''
